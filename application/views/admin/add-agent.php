                                ...
                                <div role="tabpanel" class="tab-pane active in fade" id="tab1">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <img src="<?=ASSETS_ADMIN_DIR_IMG?>pic-upload.png" alt="" width="300px" class="img-responsive" />
                                            <br />
                                            <form action="<?php echo base_url();?>admin/insert_agent" id="frmFileUpload" class="dropzone dz-clickable" method="POST" enctype="multipart/form-data">
												...
												<div class="form-group form-float form-group-lg">
													...
													<input type="submit" name="add" class="btn btn-primary btn-lg waves-effect" value="ADD AGENT" />
												</div>
                                            </form>
                                        </div>
                                        <div class="col-lg-4"></div>
